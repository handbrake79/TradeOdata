...
public class Helper extends OrmLiteSqliteOpenHelper {
    ...
    public Helper(Context context, String databaseName, int databaseVersion) {
    ...
    public Helper(Context context, String databaseName, SQLiteDatabase.CursorFactory factory, int databaseVersion, int configFileId) {
        super(context, databaseName, factory, databaseVersion, configFileId);
    }

    public Helper(Context context, String databaseName, SQLiteDatabase.CursorFactory factory, int databaseVersion, File configFile) {
        super(context, databaseName, factory, databaseVersion, configFile);
    }

    public Helper(Context context, String databaseName, SQLiteDatabase.CursorFactory factory, int databaseVersion, InputStream stream) {
    ...
    public static Helper getInstance(Application application) {
        ...
        if (instance == null) {
            instance = new Helper(application,"test.db", 1);
        }
        return instance;
    }
    ...
    public static Dao<Charact, Object> getCharDao() {
        try {
    ...
    public static Dao<Product, Object> getProductsDao() {
    ...
    public static Dao<Unit, Object> getUnitsDao() {
        try {
    ...
    public static Dao<Route, Object> getRoutesDao() {
        try {
    ...
    public static Dao<StartingPoint, Object> getStartingPointsDao() {
        try {
